 ...
 */
abstract contract UpgradeFlexibleCustomERC2771Context is Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    address private _altTrustedForwarder;
    ...
    function __UpgradeFlexibleCustomERC2771Context_init(uint8 defaultChoice) internal onlyInitializing {
     ...
     */
    uint256[50] private __gap;//50 o 49 after added a 32 bytes state variable?
}
